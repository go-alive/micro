module github.com/go-alive/micro
...
require (
	...
	github.com/go-alive/cli v0.0.0-00010101000000-000000000000
	github.com/go-alive/go-micro v1.16.0
	github.com/go-alive/go-plugins/registry/zookeeper v0.0.0-00010101000000-000000000000
	//github.com/go-alive/go-plugins v0.0.0-00010101000000-000000000000 // indirect
