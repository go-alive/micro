...
import (
	...
	"github.com/go-alive/go-micro/agent/command"
	"github.com/go-alive/go-micro/agent/input"
	log "github.com/go-alive/go-micro/logger"
	botc "github.com/go-alive/micro/internal/command/bot"

	proto "github.com/go-alive/go-micro/agent/proto"

	// inputs
	_ "github.com/go-alive/go-micro/agent/input/discord"
	_ "github.com/go-alive/go-micro/agent/input/slack"
	_ "github.com/go-alive/go-micro/agent/input/telegram"
)
