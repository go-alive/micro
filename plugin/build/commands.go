...
import (
	...
	goplugin "github.com/go-alive/go-micro/plugin"
...
func build(ctx *cli.Context) error {
	...
	// set the path
	if len(path) == 0 {
		// github.com/go-alive/go-plugins/broker/rabbitmq
		// github.com/go-alive/go-plugins/micro/basic_auth
		path = filepath.Join("github.com/go-alive/go-plugins", typ, name)
	}
